...
export const MiPerfil = () => {
    ...
    const [formData, setFormData] = useState({
        username: "juniorarias",
        role: "Administrador",
        lastActive: "Hace 5 minutos",
        persona: {
            tipo_documento: "Cédula de Ciudadanía",
            numero_documento: "1.093.090.4696",
            primer_nombre: "Junior",
            segundo_nombre: "Edimer",
            primer_apellido: "Arias",
            segundo_apellido: "Castellanos",
            fecha_nacimiento: "2004-04-02",
            lugar_nacimiento: "Cucuta, Norte de santander",
            direccion_residencia: "Avenida 16 # 8 - 98",
            numero_telefono: "318 311 1056",
            fecha_creacion: "2025-01-20",
            fecha_modificacion: "2025-01-20"
        }
    });
    ...
    const EditableCard = ({ icon: Icon, label, value, name, nestedName, type = "text", fullWidth = false, editable = true }) => (
        <div className={`flex flex-col p-4 bg-slate-50 border transition-all duration-300 rounded-2xl ${isEditing && editable
            ...
            {isEditing && editable ? (
                <input
                    type={type}
                    value={value}
                    onChange={(e) => handleChange(e, name, nestedName)}
